...
#define COL_MAX                  16
#define COL_REGULAR              1
#define COL_GOSSIP               2
#define COL_SHOUTS               3
#define COL_QUESTION             4
#define COL_CASTLE               5
#define COL_TELL                 6
#define COL_SAYS                 7
#define COL_SOCIALS              8
#define COL_HIGHLIGHT            9
#define COL_DAMAGE               10
#define COL_DEFENSE              11
#define COL_DISARM               12
#define COL_HERO                 13
#define COL_WIZINFO              14
#define COL_IMMTALK              15
#define COL_ROOM_NAME            16
...
extern struct board_data board_type;
...
#define OFFENSE_FILE    "offense.txt"
...
/* Defined in update.c, beside the scatterer that enforces them. */
#define HERB_CEILING            40
#define COMPONENT_CEILING       25
...
char* get_guildname   ( const int guild );
int     castle_lookup   ( const char *name);
char* get_castlename  ( const int guild );
