...
/*    { "put",		do_put,		POS_RESTING,	 0,  LOG_NORMAL, 1 },*/
	...
	*/
    ...
    { "practicelist",   do_practicelist, POS_SLEEPING,   5,  LOG_NORMAL, 1 },
    ...
    { "enervate",       do_enervate,    POS_FIGHTING,   15,  LOG_NORMAL, 0 },
    { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
...
/*    { "finger",         do_finger,      POS_DEAD,       ML,  LOG_NORMAL, 1 },*/
    ...
    { "prestore",       do_prestore,    POS_DEAD,       L5,  LOG_ALWAYS, 1 },
