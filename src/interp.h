...
DECLARE_DO_FUN( do_get_maxload_with_players );
DECLARE_DO_FUN( do_lst_maxload  );
DECLARE_DO_FUN( do_set_maxload  );
...
DECLARE_DO_FUN( do_imweather    );
DECLARE_DO_FUN( do_lights       );
